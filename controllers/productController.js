...
export const getProductsSoinsDuCorps = async (req, res) => {
...
export const getProductsSoinsDuVisage = async (req, res) => {
...
export const getProductsMaquillage = async (req, res) => {
...
export const getProductsBeauteDesMains = async (req, res) => {
